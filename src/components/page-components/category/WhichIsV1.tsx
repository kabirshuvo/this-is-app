...
// const WhichIsV1: React.FC<{ params: Params }> = ({ params }) => {
...
//       <div className="flex items-start justify-center gap-3 lg:gap-4 mt-4">
//         <h3 className="text-2xl lg:text-4xl text-center uppercase mt-1">
...
//         className="max-w-[80%] mx-auto items-center"
//       />
...
//             width={32}
//             height={32}
//             className="rotate-180 transition duration-200 ease-in-out"
//           />
//         </button>
//       </div>
